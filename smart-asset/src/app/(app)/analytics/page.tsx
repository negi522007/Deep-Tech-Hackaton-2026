...
// Workflow step times from sample-data (hours)
...
export default function AnalyticsPage() {
  ...
  return (
    <div>
      ...
      {/* ================================================================
          INSIGHT CRITIQUE — Le goulot d'étranglement sourcing
          ================================================================ */}
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
        {[
          ...
          { icon: TrendingUp, label: 'Part des pannes méca.', value: `${Math.round((failures.filter(f => f.category === 'mechanical').length / failures.length) * 100)} %`, sub: 'catégorie dominante', color: 'text-amber' },
          { icon: AlertTriangle, label: 'Pannes critiques', value: `${failures.filter(f => f.severity === 'critical').length}`, sub: 'sur ' + failures.length + ' total', color: 'text-crit' },
