          ...
          <div>
            ...
            <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, ease, delay: 0.25 }}
              ...
              <div className="flex gap-2 pt-1">
                <Link href="/failures/new" className="text-xs text-steel hover:text-cyan transition flex items-center gap-1">
                  <ScanLine size={12} /> Tester le diagnostic IA directement
                </Link>
              </div>
            </motion.div>
