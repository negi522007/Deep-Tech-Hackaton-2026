  ...
  return (
    <group ref={ring}>
      ...
      <mesh rotation={[Math.PI / 2, 0, 0]}>
        ...
        <meshStandardMaterial color="#22D3EE" emissive="#22D3EE" emissiveIntensity={1.4} metalness={0.6} roughness={0.3} />
      </mesh>
      ...
      {[0, 1, 2].map((i) => (
        <Float key={i} speed={2 + i} rotationIntensity={1.5} floatIntensity={1.2}>
          <mesh position={[2.6 + i * 0.15, 0.6 - i * 0.6, -0.4 + i * 0.3]}>
            ...
            <meshStandardMaterial color="#7DD3FC" metalness={0.85} roughness={0.3} emissive="#22D3EE" emissiveIntensity={0.25} />
          </mesh>
        </Float>
      ))}
    </group>
